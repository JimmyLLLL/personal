                    ...
                    <CenterWrapper>
                        <span className="wrapper">
                            <div className="avatarWrapper">
                                <img className="avatar" src={`http://localhost:8003/uploads/avator/${this.props.userInfo.avator}`} alt="用户头像"></img>
                            </div>                                  
                            <div className="key">账号: {this.props.userInfo.name}</div>
                            <div className="key">BLOG</div><a href={`http://localhost:3005/blog/personalBlog/${this.props.match.params.name}`} target="_blank" className="blogA"><div className="value red">这是一条时光隧道，在此见证此用户的过去的记录</div></a>
